              ...
              {requests.sent.length === 0 ? (
                ...
                requests.sent.map((request) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-start gap-3 md:gap-4 flex-1 min-w-0">
                        <div className="flex items-center justify-center w-11 h-11 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-[#1451CB] to-[#1434CB] shadow-lg shadow-[#1451CB]/30 flex-shrink-0 transition-transform hover:scale-110">
                          <span className="text-lg md:text-xl font-bold text-white">
                            {(
                              (request.toUser.name ||
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-base md:text-lg font-bold text-[#1451CB] mt-1">
                            {formatCurrency(request.amount, request.currency)}
                          </p>
                          {request.description && (
                            <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1 line-clamp-1">
                      ...
                      {request.status === "PENDING" && (
                        <Button
                          ...
                          className="text-xs text-red-600 hover:text-red-700 hover:bg-red-50 dark:hover:bg-red-950 whitespace-nowrap flex-shrink-0"
                        >
                          Cancel
                        </Button>
                      )}
